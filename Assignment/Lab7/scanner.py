...
class Scanner:
    ...
    def __init__(self, input_file):
        ...
        # file_path = r"C:\Users\tomar\OneDrive\Documents\UC\24sem1\Cosc261 Formal Languages\Assignment Information\lab_7\program"
    ...
    def consume(self, *expected_tokens):
        ...
        if self.next_token[0] in expected_tokens:
            ...
            self.unexpected_token(token[0], expected_tokens)
